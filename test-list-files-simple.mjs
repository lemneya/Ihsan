import listFiles from "./skills/list_files.js";
...
async function run() {
  ...
  check("Root has skills/ dir", root.entries.some((e) => e.name === "skills" && e.type === "dir"));
  check("Root has src/ dir", root.entries.some((e) => e.name === "src" && e.type === "dir"));
  check("Root skips node_modules", !root.entries.some((e) => e.name === "node_modules"));
  check("Root skips .git", !root.entries.some((e) => e.name === ".git"));
  ...
  console.log("\n" + skills.summary);
  check("Skills has write_file.ts", skills.entries.some((e) => e.name === "write_file.ts"));
  check("Skills has list_files.ts", skills.entries.some((e) => e.name === "list_files.ts"));
  check("Skills has browser_search.ts", skills.entries.some((e) => e.name === "browser_search.ts"));
  check("Skills has generate_slides.ts", skills.entries.some((e) => e.name === "generate_slides.ts"));
  check("Skills has memorize.ts", skills.entries.some((e) => e.name === "memorize.ts"));
  ...
  console.log("\n" + src.summary);
  check("src/ has agent-os/ dir", src.entries.some((e) => e.name === "agent-os" && e.type === "dir"));
  // Find agent-os children
  const agentOs = src.entries.find((e) => e.name === "agent-os");
  check("agent-os/ has agent.ts", agentOs?.children?.some((e) => e.name === "agent.ts"));
  check("agent-os/ has safety.ts", agentOs?.children?.some((e) => e.name === "safety.ts"));
  check("agent-os/ has types/ dir", agentOs?.children?.some((e) => e.name === "types" && e.type === "dir"));
  const types = agentOs?.children?.find((e) => e.name === "types");
  check("types/ has skill.interface.ts", types?.children?.some((e) => e.name === "skill.interface.ts"));
