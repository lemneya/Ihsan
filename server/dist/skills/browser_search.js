...
const browserSearch = {
    name: "browser_search",
    description: "Search the web using DuckDuckGo and return structured results with titles, snippets, and URLs. Use this to find current information, research topics, or discover relevant web pages.",
